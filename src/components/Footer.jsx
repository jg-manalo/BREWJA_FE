    ...
    <footer className="bg-black/20 backdrop-blur-md p-4 flex justify-start w-full items-center border-b border-white/10">
      ...
      <div className=''>
        <ul className='flex gap-2 text-white'>
          <li>
            {/* credits to Font Awesome Free 6.5.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2024 Fonticons, Inc. */}
            <a href="https://www.facebook.com/jjgm46">
